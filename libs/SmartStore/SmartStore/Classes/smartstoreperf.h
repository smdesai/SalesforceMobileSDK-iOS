...
extern CQL_WARN_UNUSED cql_code add_marker(sqlite3 *_Nonnull _db_, cql_int64 time_, cql_string_ref _Nonnull marker_, cql_int32 payload_size_, cql_int32 duration_);
...
#define dump_perf_data_types_count 4
...
#define dump_perf_average_data_types_count 4
